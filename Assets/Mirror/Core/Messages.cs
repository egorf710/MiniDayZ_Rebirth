...
namespace Mirror
{
    ...
    [Serializable]
    public struct connect_player
    {
        public int netId;
        public GameObject playerObject;

    }
    public struct SetNetPlayerMessage : NetworkMessage
    {
        public string playerName;
        public int playerId;
        public string gameTimeData;
        public List<connect_player> connected_players;
        public List<int> uniqeIDname;
    }
